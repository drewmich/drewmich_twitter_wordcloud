...
def main():
    if (len(sys.argv) != 3):
        print("Error: execute function with 3 arguments including program name:")
        print("Example: ./twiter_proj.py show michigan")

    if (sys.argv[1] != "save" and sys.argv[1] != "show"):
        print("Error: second argument should be either 'save' or 'show'")
        print("Example: ./twitter_proj.py show michigan")
